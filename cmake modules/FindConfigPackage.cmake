...
#   Path.
# - PROJECT_BRIEF: a small description of the project.
#
...
function(ConfigPackage PACKAGE VERSION ID_PREFIX PROJECT_BRIEF)
    ...
    if(EXISTS "${PROJECT_TEMPLATE_DIR}/desktop.in")
        configure_file("${PROJECT_TEMPLATE_DIR}/desktop.in" "${PROJECT_BINARY_DIR}/${PACKAGE}.desktop" @ONLY)
    endif()
    
    if(EXISTS "${PROJECT_TEMPLATE_DIR}/pkg-config.pc.in")
        configure_file("${PROJECT_TEMPLATE_DIR}/pkg-config.pc.in" "${PROJECT_BINARY_DIR}/lib${PACKAGE}.pc" @ONLY)
    endif()

    set(PACKAGE "${PACKAGE}" PARENT_SCOPE)
    set(APP_ID "${APP_ID}" PARENT_SCOPE)
    ...
    set(PROJECT_BRIEF "${PROJECT_BRIEF}" PARENT_SCOPE)
